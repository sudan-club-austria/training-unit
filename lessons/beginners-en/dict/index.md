...
نوع بيانات أساسي آخر سنقدمه هو *القاموس* (Dictionary) ، أو باختصار، `dict`.

القاموس هو هيكل بيانات يتكون من أزواج متعددة من *مفتاح/قيمة*،
يربط *المفاتيح* بقيمها المقابلة. غرضه الرئيسي هو إيجاد قيمة أي مفتاح معين بشكل سريع وفعّال.
...
ويجب ألا تكون قابلة للتغيير (القيم *القابلة للتعديل*، مثل القوائم والقواميس ( lists and dictionaries )
...
تحتوي القواميس (Dictionary) على عدد من الطرق المفيدة التي يجدر معرفتها: 
...
> وتتصرف كمجموعة.
> هذا موصوف جيدًا في [documentation](https://docs.python.org/3/library/stdtypes.html#dictionary-view-objects).
...
## القواميس ومعاملات الكلمات المفتاحية للدالة - `args` and `kwargs`
...
حول القواميس، يمكنك إلقاء نظرة على [cheatsheet.](https://github.com/ehmatthes/pcc/releases/download/v1.0.0/beginners_python_cheat_sheet_pcc_dictionaries.pdf).
...
[documentation](https://docs.python.org/3/library/stdtypes.html#mapping-types-dict) بايثون.
